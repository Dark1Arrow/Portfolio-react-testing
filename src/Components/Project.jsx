    ...
    return (
        <div>
            ...
            <div className='project-hero w-full h-[92vh] '>
                <div className='w-full h-full flex justify-center items-center'>
                    <div className='h-full w-full flex justify-between'>
                        ...
                        <div className='h-full hidden md:flex justify-between flex-col py-20'>
                            <motion.div initial={{ rotate: 90 }} animate={{ rotate: leftGear ? 90 : 0 }} transition={{ duration: 1, ease: easeInOut }} onClick={() => setLeftGear(true)}><img className='cursor-pointer w-[90px] lg:w-[130px]' src="projectPage/key.svg" alt="" /></motion.div>
                            <motion.div initial={{ rotate: -90 }} animate={{ rotate: leftGear ? -90 : 0 }} transition={{ duration: 1, ease: easeInOut }} onClick={() => setLeftGear(false)}><img className='cursor-pointer w-[90px] lg:w-[130px]' src="projectPage/key.svg" alt="" /></motion.div>
                        </div>
                    ...
                    <div className='absolute z-50 w-full h-[250px] md:h-[300px] bg-[#151617] p-10 lg:px-20 flex justify-between items-center'>
                        <div className='md:relative absolute left:10 sm:left-20 md:-translate-y-0 -translate-y-[250px]'>
                            <div className='md:translate-x-0 translate-x-14'>
                                <motion.img initial={{ rotate: 90 }} animate={{ rotate: leftGear ? 90 : 0 }} transition={{ duration: 1, ease: easeInOut }} className='cursor-pointer w-[70px] sm:w-[90px] lg:w-[120px] ' src="projectPage/gear.svg" alt="" />
                            </div>
                            <div className=' -translate-y-3 md:translate-x-14 rotate-12'>
                                <motion.img initial={{ rotate: 90 }} animate={{ rotate: leftGear ? 90 : 0 }} transition={{ duration: 1, ease: easeInOut }} className='cursor-pointer w-[70px] sm:w-[90px] lg:w-[120px]  origin-center ' src="projectPage/gear.svg" alt="" />
                            </div>
                        </div>

                        <div className='capitalize flex flex-col mx-auto gap-5 justify-center items-center'>
                            <div className='text-4xl md:text-5xl w-[150px] md:w-[400px] flex text-center' style={{ fontFamily: "montagu slab" }}>my Creative journey</div>
                            <div className='text-xl md:text-3xl text-[#8A8A8A]'>2024 -2025</div>
                        </div>

                        <div className='absolute md:relative right-10 sm:right-20 md:translate-y-0 translate-y-[250px]'>
                            <div className=''><motion.img initial={{ rotate: 90 }} animate={{ rotate: leftGear ? 90 : 0 }} transition={{ duration: 1, ease: easeInOut }} className='w-[70px] sm:w-[90px] lg:w-[120px]' src="projectPage/gear.svg" alt="" /></div>
                            <div className='-translate-y-3 -translate-x-14 rotate-12'><motion.img initial={{ rotate: 90 }} animate={{ rotate: leftGear ? 90 : 0 }} transition={{ duration: 1, ease: easeInOut }} className='w-[70px] sm:w-[90px] lg:w-[120px]  origin-center ' src="projectPage/gear.svg" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className=' ui-section w-full h-[60vh] sm:h-[80vh] md:h-[80vh] lg:h-[95vh] my-[20vh] md:my-[50vh] flex justify-between flex-col'>
                ...
                <div className=' md:mx-auto mx-5 min-w-[80vw] lg:min-w-[70vw] min-h-[30vh] sm:min-h-[50vh] lg:min-h-full grid grid-rows-2 grid-cols-2 md:grid-cols-3 gap-2 sm:gap-4 capitalize'>
                    ...
                    <div className='border border-[#252525] bg-[#151617] md:order-2 order-1 flex justify-between flex-col'>
                        <div className='w-full text:lg md:text-2xl font-semibold p-5 sm:p-10'>movie <br /> recomdation</div>
                    ...
                    <div className='border border-[#252525] bg-[#151617] md:order-3 order-2 flex-col justify-between'>
                        <div className='text-lg md:text-2xl font-semibold sm:p-10 flex mx-auto h-[50%] w-[90%] justify-center'>
                        ...
                        <div className='w-full sm:pb-20 overflow-hidden'> <motion.img className='w-[50%] md:w-[220px] h-[50%]' src="projectPage/grid3.svg" alt="" /></div>
                    </div>
                    <div className='border border-[#252525] bg-[#ADB5BD] md:order-4 order-3 p-2 md:p-20 flex justify-center items-center'>
                        <div className='w-[90%] md:p-10 p-5 bg-[#1A1A18] flex flex-col justify-between item-center'>
                            <div className='flex text-center text-lg md:text-2xl mx-auto'>Turning <br /> designs <br /> into <br /> reality.</div>
                            ...
                            <div key={index} className='w-[100vw] h-[90vh] lg:h-[80vh] p-5 sm:p-10'>
                                <div className='w-full h-full  flex flex-col-reverse lg:flex-row  justify-between p-5 sm:p-10 xl:p-20 items-center'>
                                    <div className='w-[100%] md:w-[90%] my-auto lg:w-[30%] h-[40%] lg:h-[90%] flex flex-col justify-center gap-5'>
                                        <div className='text-2xl md:text-3xl'>MovieFlix - Your Ultimate Movie Guide</div>
                                        <div className='text-sm md:text-lg text-[#BFBFBF]'>MovieFlix is a MERN app for personalized movie recommendations, top 10 lists, and movie searches using OMDB and TMDB APIs.</div>
                                        <div className='xl:flex-row flex-col flex  gap-5'>
                                            <button className=' sm:hover:font-semibold sm:hover:bg-[#2164ff] transition-all ease-in-out duration-500 bcapitalize py-3 px-10 bg-[#7729ff] rounded-[10px] text-lg md:text-xl'>view website</button>
