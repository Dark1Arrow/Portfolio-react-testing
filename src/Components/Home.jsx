        ...
        <div>
                ...
                <motion.div className='p-5 md:py-10 md:px-20 inner-hero-section bg-white w-full max-h-auto min-h-full border-2 border-[#414638] md:rounded-[30px] flex flex-col justify-between '
                    ...
                    <nav className=' w-full flex justify-between overflow-hidden '>
                        ...
                        <motion.div className=' my-auto lg:flex hidden px-10 py-4 rounded-full bg-[#00000035] backdrop-blur-[5px]  border border-[#555216] '
                            ...
                            animate={{ y: 0, opacity: 1 }}
                            transition={{ duration: 0.5, delay: 1, ease: easeInOut }}>
                            <ul className='flex font-normal text-[18px] text-white'>
                        ...
                        <div className='lg:hidden my-auto cursor-pointer'><img className='w-[30px]' onClick={() => setActiveBar(true)} src="./homePage/menu.svg" alt="" /></div>
                    </nav>
                    ...
                    <div className='hero-mid w-full gap-10 lg:gap-0 flex justify-between flex-col-reverse lg:flex-row'>
                        <motion.div
                            ...
                            className='my-auto'>
                            <motion.div className='hero-mid-left bg-[#00000035] w-full lg:w-[40vw] font-medium lg:text-3xl sm:text-3xl text-2xl lg:p-10 p-5 sm:p-10 backdrop-blur-[5px] rounded-[30px] border border-[#555216] text-center ' style={{
                                letterSpacing: 4,
                                wordSpacing: 15,
                            }}
                        ...
                        <div className='m-auto flex justify-center'>
                            < motion.div className='w-[250px] sm:w-[300px] lg:w-[370px] h-[250px] sm:h-[300px] lg:h-[370px] border rounded-full flex justify-around border-[#555216] bg-[#00000035] backdrop-blur-[5px]'
                                initial={{ scale: 0.5, opacity: 0 }}
                                animate={{ scale: 1, opacity: 1 }}
                                transition={{ duration: 1, delay: 0.5, ease: "easeInOut", }}>
                                <motion.div className=' w-[200px] sm:w-[250px] lg:w-[300px] h-[200px] sm:h-[250px] lg:h-[300px] border rounded-full m-auto border-[#555216] drop-shadow-2xlxl' style={{
                    ...
                    <div className="overflow-hidden hero-buttons  mt-5  xl:w-[40vw] ">
                        <div className=' w-full overflow-hidden flex justify-center lg:justify-between lg:gap-5'>
                            <Link to="/Project"><motion.button className='transition-all ease-in-out duration-500 sm:hover:bg-black bg-[#00000090] scale-0 backdrop-blur-[5px] w-fit m-auto text-white font-normal text-xl xl:text-xl px-12 py-4  rounded-full' style={{
                                letterSpacing: 4,
                                wordSpacing: 10,
                            }}
                                initial={{ y: 80, opacity: 0 }}
                            ...
                            <Link to="/Contact"> <motion.button className=' transition-all ease-in-out duration-500 sm:hover:bg-[#1e1f1e]  lg:flex hidden w-fit m-auto  text-white font-normal text-xl xl:text-xl px-12 py-4 border border-[#555216] bg-[#ffffff15] backdrop-blur-[5px] rounded-full' style={{
                                letterSpacing: 4,
                                wordSpacing: 10,
                            }}
                                initial={{ y: 80, opacity: 0 }}
            ...
            <div className='my-[100px] about-section p-10 sm:p-20'>
                <div className=' w-[70vw] m-auto text-white grid grid-cols-1 grid-rows-4 gap-5 sm:grid-cols-2 sm:grid-rows-2 '>
                    ...
                    <div className='sm:order-2 row-span-6 flex md:justify-start justify-end items-center md:items-start'>
                        <div className='xl:w-[90%] w-full text-[#8A8A8A] text-3xl sm:text-3xl'>I’m a dedicated <span className='text-white'>UI designer</span> , <span className='text-white'>web designer</span> and <span className='text-white'>Full-stack developer</span> with a strong foundation in both <span className='text-white'>frontend</span> and <span className='text-white'>backend</span> technologies. </div>
                    </div>
            ...
            <div className='project-section w-full bg-[#151515] p-10 sm:p-20'>
                ...
                <div className=' pt-20 lg:pt-40 flex justify-around flex-wrap gap-20 mx-auto w-[80vw]'>
                    {project.map((val, index) => (
                        <motion.div key={index} className='mb-5 lg:mb-20 h-[40vh] lg:h-[50vh] w-[450px] bg-[#1D1D1D] rounded-[15px]'>
            ...
            <div className='skill-section'>
                ...
                <div className=' w-[90vw] sm:w-[80vw] h-[60vh] sm:h-[75vh] mx-auto grid gap-2 grid-cols-2 lg:grid-cols-4 grid-rows-3 overflow-hidden capitalize'>
                    <div className=' border border-black order-1 hidden lg:flex justify-center items-center text-xl text-center capitalize p-5 bg-[#1E2024]'>
                        <div className='w-full h-full flex justify-start gap-10 items-center pl-4'>
                            <div className='w-[90px] h-[90px] bg-[#676767] rounded-full text-5xl flex justify-center items-center text-center'>ui</div>
                            <div className='w-[50px]'>designer
                                web designer</div>
                        </div>
                    </div>
                    <div className=' border border-black bg-[#1E2024] order-2 hidden lg:flex justify-center items-center text-xl text-center flex-col gap-5 capitalize p-5'>
                    ...
                    <div className=' border border-black bg-[#1E2024] row-span-2 order-3 flex justify-center flex-col items-start gap-5 p-5 lg:p-20'>
                        <div className='text-xl sm:text-2xl pr-14'>Programming Language</div>
                        <div className='text-lg sm:text-xl tracking-[5px] font-light'>c++ <br />
                            HTML <br />
                            CSS <br />
                    ...
                    <div className='  border border-black bg-[#1E2024] order-4 flex justify-center items-center flex-col gap-5'>
                        <div className='text-xl'>tools i know</div>
                    ...
                    <div className=' border border-black bg-[#1E2024] flex  order-6 text-xl sm:text-2xl  capitalize'>
                    ...
                    <div className=' border border-black bg-gradient-to-t from-[#151C2B] to-[#232F48] order-7 col-span-2 flex justify-center gap-4 items-center flex-col p-5'>
                        <div className='text-lg sm:text-xl font-light text-center capitalize sm:px-10'>
                            Learn more about me and my journey in web development and design.
                        </div>
                        <Link to="/about"><button className=' sm:hover:bg-white sm:hover:text-black sm:hover:scale-110 transition-all ease-in-out duration-500 bg-[#1E1E1E] w-[200px] min-h-[50px] text-[18px] rounded-full border border-[#252525]' >Learn more</button></Link>
                    </div>
                </div>
